...
- Refreshed the live artifacts with `python3 scripts/trial_signup_smoke_check.py --json-out docs/smoke-checks/latest-trial-signup-smoke-check.json --markdown-out docs/smoke-checks/latest-trial-signup-smoke-check.md --owner-messages-dir docs/smoke-checks/owner-ready --owner-messages-archive-dir docs/smoke-checks/owner-ready/archive --escalation-packet-dir docs/smoke-checks/escalation-packet --escalation-packet-archive-dir docs/smoke-checks/escalation-packet/archive`, which regenerated the send-ready packet plus archived snapshots at 2026-04-05 7:17 AM ET.
